...
{	
	...
	CDataType* enumerable_base = FindDataType(semanter, "IEnumerable", std::vector<CDataType*>());
...
//	while_loop_method_call_expr->AddChild(while_loop_var_ref_expr);
	...
	enumerator_var->Type = FindDataType(semanter, "IEnumerator", std::vector<CDataType*>());
