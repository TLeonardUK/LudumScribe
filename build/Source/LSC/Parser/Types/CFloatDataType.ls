...
// =================================================================
public class CFloatDataType : CNumericDataType
{
	public CFloatDataType(CToken token)
	{
		Token = token;
	}
	...
	{	
		return semanter.GetContext().GetASTRoot().FindDeclaration(semanter, "float").Semant(semanter) as CClassASTNode;
	}
