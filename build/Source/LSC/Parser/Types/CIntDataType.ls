...
// =================================================================
public class CIntDataType : CNumericDataType
{
	public CIntDataType(CToken token)
	{
		Token = token;
	}
	...
	{	
		return semanter.GetContext().GetASTRoot().FindDeclaration(semanter, "int").Semant(semanter) as CClassASTNode;
	}
	
	public virtual override bool IsEqualTo(CSemanter semanter, CDataType type)
	{
		return (type as CIntDataType) != null;
	}
